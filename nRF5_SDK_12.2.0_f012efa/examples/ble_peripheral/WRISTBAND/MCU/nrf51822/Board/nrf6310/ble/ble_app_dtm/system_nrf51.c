...
bool __INLINE is_manual_peripheral_setup_needed (void); 
bool __INLINE is_output_31_setup_needed (void); 
...
/**
  @brief Function for setting up the microcontroller system.
...
/**
  @brief Function for updating the variable SystemCoreClock and must be called whenever the core
...
bool __INLINE is_manual_peripheral_setup_needed (void) 
{
    switch ((NRF_FICR->CONFIGID & FICR_CONFIGID_HWID_Msk) >> FICR_CONFIGID_HWID_Pos)
    {
        ...
        /* WARNING: Other device than those defined is found. Since no information is available, 
                ...
                to produce any device new devide that will need it. */  
