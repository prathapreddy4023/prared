...
#line 45 "..\\..\\..\\..\\Include\\compiler_abstraction.h"
...
#line 26 "..\\..\\..\\..\\Source\\templates\\system_nrf51.c"
#line 27 "..\\..\\..\\..\\Source\\templates\\system_nrf51.c"
...
static _Bool is_output_31_setup_needed (void); 
...
void SystemInit (void)
{
    ...
    {
        ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[31] = ((1UL)     << (0UL))    |
                                ((0UL)  << (1UL))  |
                                ((0x00UL)  << (2UL))   |
                                ((0x00UL)     << (8UL))  |
                                ((0x00UL) << (16UL));
        ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = 1UL << 31;
    }
}
...
#line 118 "..\\..\\..\\..\\Source\\templates\\system_nrf51.c"
...
static _Bool is_manual_peripheral_setup_needed (void) 
{
    switch ((((NRF_FICR_Type *) 0x10000000UL)->CONFIGID & (0xFFFFUL << (0UL))) >> (0UL))
    {
        case (0x1EUL): return 1;
        case (0x24UL): return 1;
        case (0x2DUL): return 0;
        case (0x2EUL): return 0;
        case (0x31UL): return 1;
        case (0x1DUL): return 1;
        case (0x2AUL): return 0;
        case (0x2BUL): return 0;
        case (0x34UL): return 0;
        case (0x2CUL): return 0;
        case (0x2FUL): return 1;
        case (0x26UL): return 1;
        case (0x27UL): return 1;
        case (0x33UL): return 1;
...
static _Bool is_output_31_setup_needed (void) 
{
    switch ((((NRF_FICR_Type *) 0x10000000UL)->CONFIGID & (0xFFFFUL << (0UL))) >> (0UL))
    {
        case (0x1EUL): return 1;
        case (0x24UL): return 1;
        case (0x2DUL): return 1;
        case (0x2EUL): return 1;
        case (0x31UL): return 0;
        case (0x1DUL): return 1;
        case (0x2AUL): return 1;
        case (0x2BUL): return 1;
        case (0x34UL): return 1;
        case (0x2CUL): return 1;
        case (0x2FUL): return 0;
        case (0x26UL): return 1;
        case (0x27UL): return 1;
        case (0x33UL): return 1;
