...
#define SQUARE_WAVE_PIN_NO_1               		21                                      /**< Is on when device is advertising. */
...
__inline static void gpiote_1_init(void)
{
			APP_GPIOTE_INIT(APP_GPIOTE_MAX_USERS);	
			nrf_gpiote_task_config(0,21, NRF_GPIOTE_POLARITY_TOGGLE, \
...
__inline static void square_wave_init(void)
{
	nrf_gpio_cfg_output(SQUARE_WAVE_PIN_NO_1);
}
...
{
	uint32_t err_code;
	err_code = sd_ppi_channel_enable_clr( (PPI_CHEN_CH0_Msk) | (PPI_CHEN_CH1_Msk)| (PPI_CHEN_CH2_Msk));
    APP_ERROR_CHECK(err_code);
}
...
void square_wave_stop(void)
{
    ...
    nrf_gpio_pin_set(SQUARE_WAVE_PIN_NO_1);
}
...
__inline static void gpiote1_init(void)
{
			APP_GPIOTE_INIT(APP_GPIOTE_MAX_USERS);	
			nrf_gpiote_task_config(0,SQUARE_WAVE_PIN_NO_1, NRF_GPIOTE_POLARITY_TOGGLE, \
                           NRF_GPIOTE_INITIAL_VALUE_LOW);
}
