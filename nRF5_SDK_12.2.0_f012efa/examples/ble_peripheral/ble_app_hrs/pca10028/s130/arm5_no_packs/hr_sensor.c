...
//    static app_twi_transfer_t const transfers[] =
//    {			 
//        LM75B_READ(&lm75b_conf_reg_addr,  m_buffer,4),
...
//static void mx_rtc_handler(void)
//{
//   // if (int_type == NRF_DRV_RTC_INT_TICK)
//    {
//			uint8_t a[5];
//        #define LM_READ(p_reg_addr, p_buffer, byte_cnt) \
//					APP_TWI_WRITE(0x57, 0x16, 1,        APP_TWI_NO_STOP), \
//					APP_TWI_READ (0x57, p_buffer,   byte_cnt, 0)

//				#define LM_READ_TEMP(p_buffer) \
//					LM_READ(0x16, p_buffer, 2)
//          static app_twi_transfer_t const transfers[] =
//					{
//						LM_READ_TEMP(&m_buffer[4])	
//					};
//					 NRF_LOG_INFO("LM75B:\r\n");
//         NRF_LOG_HEXDUMP_INFO(m_buffer, 4);
//    }
//}
